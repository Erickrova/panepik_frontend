...
const PreviewUsuarioBuscado = ({usuario}) => {
  ...
  return (
    <button 
        onClick={handleClick}
        className = "z-30 flex justify-start gap-4 items-center p-1 bg-gray-50 hover:bg-gray-100 rounded-md shadow-md mb-1 border-gray-200 border-b-2 w-full"
        type="button">
        <div >
...
export default PreviewUsuarioBuscado